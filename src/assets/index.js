...
export const SVG = {
  Email: (props) => (
    <img {...props} src={email} style={iconStyle} alt="email" />
  ),
  Github: (props) => (
    <img {...props} src={github} style={iconStyle} alt="Github" />
  ),
  Linkedin: (props) => (
    <img {...props} src={linkedin} style={iconStyle} alt="LinkedIn" />
  ),
  Twitter: (props) => (
    <img {...props} src={twitter} style={iconStyle} alt="Twitter" />
  ),
  Logo: (props) => (
    <img {...props} style={{ width: 60, height: 30 }} src={logo} alt="logo" />
  ),
  Pronunciation: (props) => (
    <img
      {...props}
